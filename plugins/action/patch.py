    ...
    async def run(self, tmp=None, task_vars=None):
        ...
        try:
            if src is None:
                ...
                raise _AnsibleActionDone(result=await self._execute_module(task_vars=task_vars))
            ...
            result.update(await self._execute_module('ansible.posix.patch', module_args=new_module_args, task_vars=task_vars))
